...
- **내장 단어장** — ECDICT 영어 어휘 (CET-4, CET-6, 대학원 시험, GRE, TOEFL, IELTS, 수능, 중간고사) + JLPT N5–N1 일본어 어휘
- **사용자 정의 단어장** — 직접 단어장을 만들고 수동 또는 일괄 추가
- **가져오기** — CSV 및 Anki APKG 형식 지원, 가져오기 전 필드 매핑 미리보기 및 조정 가능; Anki 학습 진행 상황 유지
- **음성 읽기** — Windows / macOS 시스템 TTS, 단어장 언어에 따라 자동으로 음성 선택; 설정 가능한 AI TTS (OpenAI 호환 API)
...
영어 단어장은 [ECDICT](https://github.com/skywind3000/ECDICT) (MIT 라이선스), 일본어 단어장은 JLPT 급별 어휘를 기반으로 합니다.
...
| 高考       | 중국 대학 입학 시험      |
| 中考       | 중국 고등학교 입학 시험  |
| JLPT-N5    | 일본어 능력 시험 N5      |
| JLPT-N4    | 일본어 능력 시험 N4      |
| JLPT-N3    | 일본어 능력 시험 N3      |
| JLPT-N2    | 일본어 능력 시험 N2      |
| JLPT-N1    | 일본어 능력 시험 N1      |
