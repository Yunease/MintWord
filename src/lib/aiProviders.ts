...
export const PROVIDERS: AiProvider[] = [
  ...
  // ─── Alibaba DashScope / 阿里百炼中国版 ──────────────────────────────
  {
    ...
    models: [
      ...
      { id: 'deepseek-v4-pro', displayName: 'DeepSeek V4 Pro', contextWindow: 1_000_000, maxOutput: 384_000, thinkingSupport: true, thinkingPattern: 'thinking_object', thinkingLevels: ['low', 'medium', 'high'], supportedParams: THINKING_PARAMS },
      { id: 'deepseek-v4-flash', displayName: 'DeepSeek V4 Flash', contextWindow: 1_000_000, maxOutput: 384_000, thinkingSupport: true, thinkingPattern: 'thinking_object', thinkingLevels: ['low', 'medium', 'high'], supportedParams: THINKING_PARAMS },
  ...
  // ─── Volcengine/火山方舟 (China) ────────────────────────────────────────
  {
    ...
    models: [
      ...
      { id: 'doubao-seed-code', displayName: 'Doubao Seed Code', contextWindow: 256_000, maxOutput: 4_096, thinkingSupport: false, supportedParams: DEFAULT_PARAMS, subOptionFilter: { planType: 'coding|agent' } },
      { id: 'doubao-seed-2.0-code', displayName: 'Doubao Seed 2.0 Code', contextWindow: 256_000, maxOutput: 32_000, thinkingSupport: false, supportedParams: DEFAULT_PARAMS, subOptionFilter: { planType: 'coding|agent' } },
      ...
      { id: 'kimi-k2-thinking', displayName: 'Kimi K2 Thinking', contextWindow: 256_000, maxOutput: 4_096, thinkingSupport: true, thinkingPattern: 'thinking_object', thinkingLevels: ['low', 'medium', 'high'], supportedParams: THINKING_PARAMS, subOptionFilter: { planType: 'coding|agent' } },
      ...
      { id: 'deepseek-v4-pro', displayName: 'DeepSeek V4 Pro', contextWindow: 256_000, maxOutput: 32_000, thinkingSupport: false, supportedParams: DEFAULT_PARAMS, subOptionFilter: { planType: 'coding|agent' } },
      { id: 'deepseek-v4-flash', displayName: 'DeepSeek V4 Flash', contextWindow: 256_000, maxOutput: 32_000, thinkingSupport: false, supportedParams: DEFAULT_PARAMS, subOptionFilter: { planType: 'coding|agent' } },
  ...
  // ─── Baidu Qianfan / 百度千帆 (China) ────────────────────────────────
  {
    ...
    models: [
      ...
      { id: 'deepseek-v4-pro', displayName: 'DeepSeek V4 Pro', contextWindow: 1_000_000, maxOutput: 131_072, thinkingSupport: true, thinkingPattern: 'thinking_object', thinkingLevels: ['low', 'medium', 'high'], supportedParams: THINKING_PARAMS },
      { id: 'deepseek-v4-flash', displayName: 'DeepSeek V4 Flash', contextWindow: 1_000_000, maxOutput: 131_072, thinkingSupport: true, thinkingPattern: 'thinking_object', thinkingLevels: ['low', 'medium', 'high'], supportedParams: THINKING_PARAMS },
      { id: 'deepseek-v3.2', displayName: 'DeepSeek V3.2', contextWindow: 128_000, maxOutput: 32_000, thinkingSupport: true, thinkingPattern: 'thinking_object', thinkingLevels: ['low', 'medium', 'high'], supportedParams: THINKING_PARAMS },
