...
export const PROVIDERS: AiProvider[] = [
  // ─── OpenAI (Chat Completions) ────────────────────────────────────────────
  {
    ...
    models: [
      ...
      { id: 'gpt-5.3', displayName: 'GPT-5.3', contextWindow: 1_000_000, thinkingSupport: false, supportedParams: DEFAULT_PARAMS },
  ...
  // ─── Grok (xAI) ───────────────────────────────────────────────────────
  {
    ...
    models: [
      ...
      { id: 'grok-imagine-image', displayName: 'Grok Imagine Image', thinkingSupport: false, supportedParams: DEFAULT_PARAMS },
    ],
  },
  ...
  // ─── Alibaba DashScope / 阿里百炼中国版 ──────────────────────────────
  {
    ...
    urlMap: {
      ...
      'token': 'https://token-plan.dashscope.aliyuncs.com/compatible-mode/v1',
      'coding': 'https://coding.dashscope.aliyuncs.com/v1',
    },
    models: [
      { id: 'qwen3.7-max', displayName: 'Qwen3.7 Max', contextWindow: 131_072, thinkingSupport: true, thinkingPattern: 'enable_thinking', thinkingLevels: ['low', 'medium', 'high'], supportedParams: THINKING_PARAMS },
      { id: 'qwen3.6-plus', displayName: 'Qwen3.6 Plus', contextWindow: 131_072, thinkingSupport: true, thinkingPattern: 'enable_thinking', thinkingLevels: ['low', 'medium', 'high'], supportedParams: THINKING_PARAMS },
      { id: 'qwen3.6-flash', displayName: 'Qwen3.6 Flash', contextWindow: 131_072, thinkingSupport: true, thinkingPattern: 'enable_thinking', thinkingLevels: ['low', 'medium', 'high'], supportedParams: THINKING_PARAMS },
      { id: 'qwen3.5-plus', displayName: 'Qwen3.5 Plus', contextWindow: 131_072, thinkingSupport: true, thinkingPattern: 'enable_thinking', thinkingLevels: ['low', 'medium', 'high'], supportedParams: THINKING_PARAMS },
      { id: 'qwen3.5-flash', displayName: 'Qwen3.5 Flash', contextWindow: 131_072, thinkingSupport: true, thinkingPattern: 'enable_thinking', thinkingLevels: ['low', 'medium', 'high'], supportedParams: THINKING_PARAMS },
      { id: 'deepseek-v4-pro', displayName: 'DeepSeek V4 Pro', contextWindow: 1_000_000, thinkingSupport: true, thinkingPattern: 'thinking_object', thinkingLevels: ['low', 'medium', 'high'], supportedParams: THINKING_PARAMS },
      { id: 'deepseek-v4-flash', displayName: 'DeepSeek V4 Flash', contextWindow: 1_000_000, thinkingSupport: true, thinkingPattern: 'thinking_object', thinkingLevels: ['low', 'medium', 'high'], supportedParams: THINKING_PARAMS },
      { id: 'glm-5.1', displayName: 'GLM-5.1', contextWindow: 128_000, thinkingSupport: false, supportedParams: DEFAULT_PARAMS },
      { id: 'MiniMax-M2.7', displayName: 'MiniMax M2.7', contextWindow: 256_000, thinkingSupport: false, supportedParams: DEFAULT_PARAMS },
      { id: 'mimo-v2.5-pro', displayName: 'MiMo V2.5 Pro', contextWindow: 131_072, thinkingSupport: true, thinkingPattern: 'builtin', supportedParams: DEFAULT_PARAMS },
    ],
  },
  ...
  // ─── Alibaba DashScope International / 阿里百炼国际版 ────────────────
  {
    ...
    urlMap: {
      ...
      'sg+token': 'https://token-plan-intl.dashscope.aliyuncs.com/compatible-mode/v1',
      'sg+coding': 'https://coding-intl.dashscope.aliyuncs.com/v1',
      'us+api': 'https://dashscope-us.aliyuncs.com/compatible-mode/v1',
      'us+token': 'https://token-plan-us.dashscope.aliyuncs.com/compatible-mode/v1',
      ...
      'token': 'https://token-plan-intl.dashscope.aliyuncs.com/compatible-mode/v1',
  ...
  // ─── Xiaomi MiMo (按量付费) ────────────────────────────────────────────
  {
    ...
    models: [
      ...
      { id: 'mimo-v2-pro', displayName: 'MiMo V2 Pro', contextWindow: 1_000_000, maxOutput: 128_000, thinkingSupport: true, thinkingPattern: 'builtin', supportedParams: DEFAULT_PARAMS },
      { id: 'mimo-v2-omni', displayName: 'MiMo V2 Omni', contextWindow: 256_000, maxOutput: 128_000, thinkingSupport: true, thinkingPattern: 'builtin', supportedParams: DEFAULT_PARAMS },
      { id: 'mimo-v2-flash', displayName: 'MiMo V2 Flash', contextWindow: 256_000, maxOutput: 64_000, thinkingSupport: true, thinkingPattern: 'builtin', supportedParams: DEFAULT_PARAMS },
      { id: 'mimo-v2-tts', displayName: 'MiMo V2 TTS', contextWindow: 8_000, maxOutput: 16_000, thinkingSupport: false, supportedParams: DEFAULT_PARAMS },
    ],
  },
  ...
  // ─── Xiaomi MiMo Token Plan ───────────────────────────────────────────
  {
    ...
    models: [
      { id: 'mimo-v2.5-pro', displayName: 'MiMo V2.5 Pro', contextWindow: 1_000_000, maxOutput: 128_000, thinkingSupport: true, thinkingPattern: 'builtin', supportedParams: DEFAULT_PARAMS },
      { id: 'mimo-v2.5-max', displayName: 'MiMo V2.5 Max', contextWindow: 1_000_000, maxOutput: 128_000, thinkingSupport: true, thinkingPattern: 'builtin', supportedParams: DEFAULT_PARAMS },
      { id: 'mimo-v2.5-flash', displayName: 'MiMo V2.5 Flash', contextWindow: 1_000_000, maxOutput: 128_000, thinkingSupport: true, thinkingPattern: 'builtin', supportedParams: DEFAULT_PARAMS },
      { id: 'mimo-v2.5-lite', displayName: 'MiMo V2.5 Lite', contextWindow: 1_000_000, maxOutput: 128_000, thinkingSupport: true, thinkingPattern: 'builtin', supportedParams: DEFAULT_PARAMS },
      { id: 'mimo-coder-v2.5', displayName: 'MiMo Coder V2.5', contextWindow: 1_000_000, maxOutput: 128_000, thinkingSupport: true, thinkingPattern: 'builtin', supportedParams: DEFAULT_PARAMS },
      { id: 'mimo-v2-pro', displayName: 'MiMo V2 Pro', contextWindow: 1_000_000, maxOutput: 128_000, thinkingSupport: true, thinkingPattern: 'builtin', supportedParams: DEFAULT_PARAMS },
      { id: 'mimo-v2-max', displayName: 'MiMo V2 Max', contextWindow: 1_000_000, maxOutput: 128_000, thinkingSupport: true, thinkingPattern: 'builtin', supportedParams: DEFAULT_PARAMS },
      { id: 'mimo-v2-flash', displayName: 'MiMo V2 Flash', contextWindow: 1_000_000, maxOutput: 128_000, thinkingSupport: true, thinkingPattern: 'builtin', supportedParams: DEFAULT_PARAMS },
    ],
    subOptions: [
      {
        id: 'region',
  ...
  // ─── Tencent Token Plan ──────────────────────────────────────────────
  {
    ...
    urlMap: {
      'cn': 'https://api.lkeap.cloud.tencent.com/v1',
      'intl-sg': 'https://lkeap.cloud.tencent.com/v1',
      'intl-gz': 'https://lkeap.gz.cloud.tencent.com/v1',
    },
    models: [
      { id: 'deepseek-v3', displayName: 'DeepSeek V3', contextWindow: 65_536, thinkingSupport: false, supportedParams: DEFAULT_PARAMS },
      { id: 'deepseek-r1', displayName: 'DeepSeek R1', contextWindow: 65_536, thinkingSupport: true, thinkingPattern: 'builtin', supportedParams: THINKING_PARAMS },
      { id: 'hunyuan-turbos-20250416', displayName: '混元 Turbo S', contextWindow: 32_768, thinkingSupport: false, supportedParams: DEFAULT_PARAMS },
    ],
  },
  ...
  // ─── Volcengine/火山方舟 (China) ────────────────────────────────────────
  {
    ...
    models: [
      { id: 'doubao-seed-2.0-pro', displayName: 'Doubao Seed 2.0 Pro', contextWindow: 128_000, thinkingSupport: true, thinkingPattern: 'thinking_object', thinkingLevels: ['low', 'medium', 'high'], supportedParams: THINKING_PARAMS },
      { id: 'doubao-seed-2.0-flash', displayName: 'Doubao Seed 2.0 Flash', contextWindow: 128_000, thinkingSupport: true, thinkingPattern: 'thinking_object', thinkingLevels: ['low', 'medium', 'high'], supportedParams: THINKING_PARAMS },
      { id: 'doubao-seed-2.0-lite', displayName: 'Doubao Seed 2.0 Lite', contextWindow: 128_000, thinkingSupport: true, thinkingPattern: 'thinking_object', thinkingLevels: ['low', 'medium', 'high'], supportedParams: THINKING_PARAMS },
      { id: 'doubao-seed-2.0-mini', displayName: 'Doubao Seed 2.0 Mini', contextWindow: 128_000, thinkingSupport: true, thinkingPattern: 'thinking_object', thinkingLevels: ['low', 'medium', 'high'], supportedParams: THINKING_PARAMS },
      { id: 'doubao-seed-2.0-vision', displayName: 'Doubao Seed 2.0 Vision', contextWindow: 128_000, thinkingSupport: false, supportedParams: DEFAULT_PARAMS },
      { id: 'deepseek-v4-pro', displayName: 'DeepSeek V4 Pro', contextWindow: 1_000_000, thinkingSupport: true, thinkingPattern: 'thinking_object', thinkingLevels: ['low', 'medium', 'high'], supportedParams: THINKING_PARAMS },
      { id: 'deepseek-v4-flash', displayName: 'DeepSeek V4 Flash', contextWindow: 1_000_000, thinkingSupport: true, thinkingPattern: 'thinking_object', thinkingLevels: ['low', 'medium', 'high'], supportedParams: THINKING_PARAMS },
      { id: 'glm-5.1', displayName: 'GLM-5.1', contextWindow: 128_000, thinkingSupport: false, supportedParams: DEFAULT_PARAMS },
      { id: 'MiniMax-M2.7', displayName: 'MiniMax M2.7', contextWindow: 256_000, thinkingSupport: false, supportedParams: DEFAULT_PARAMS },
  ...
  // ─── Baidu Qianfan / 百度千帆 (China) ────────────────────────────────
  {
    ...
    urlMap: {
      ...
      'coding': 'https://qianfan.baidubce.com/coding/v2',
    },
    models: [
      { id: 'ernie-5.0', displayName: 'ERNIE 5.0', contextWindow: 128_000, thinkingSupport: false, supportedParams: DEFAULT_PARAMS },
      { id: 'ernie-4.5-turbo', displayName: 'ERNIE 4.5 Turbo', contextWindow: 128_000, thinkingSupport: false, supportedParams: DEFAULT_PARAMS },
      { id: 'deepseek-v3.2', displayName: 'DeepSeek V3.2', contextWindow: 128_000, thinkingSupport: false, supportedParams: DEFAULT_PARAMS },
    ],
  },
  ...
  // ─── Baidu Qianfan International / 百度千帆国际版 ────────────────────
  {
    ...
    models: [
      { id: 'ernie-5.0', displayName: 'ERNIE 5.0', contextWindow: 128_000, thinkingSupport: false, supportedParams: DEFAULT_PARAMS },
      { id: 'deepseek-v3.2', displayName: 'DeepSeek V3.2', contextWindow: 128_000, thinkingSupport: false, supportedParams: DEFAULT_PARAMS },
      { id: 'glm-5', displayName: 'GLM-5', contextWindow: 128_000, thinkingSupport: true, thinkingPattern: 'builtin', supportedParams: DEFAULT_PARAMS },
      { id: 'kimi-k2.5', displayName: 'Kimi K2.5', contextWindow: 256_000, thinkingSupport: true, thinkingPattern: 'builtin', supportedParams: DEFAULT_PARAMS },
      { id: 'minimax-m2.5', displayName: 'MiniMax M2.5', contextWindow: 256_000, thinkingSupport: false, supportedParams: DEFAULT_PARAMS },
    ],
  },
];
